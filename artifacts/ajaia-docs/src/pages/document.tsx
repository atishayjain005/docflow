...
function EditorSkeleton() {
  return <div className="mx-auto max-w-[760px] px-6 pb-24 pt-24"><div className="ajaia-skeleton h-12 w-3/4 rounded bg-[hsl(var(--muted))]" /><div className="mt-5 space-y-3"><div className="ajaia-skeleton h-3 w-full rounded bg-[hsl(var(--muted))]" /><div className="ajaia-skeleton h-3 w-5/6 rounded bg-[hsl(var(--muted))]" /><div className="ajaia-skeleton h-3 w-2/3 rounded bg-[hsl(var(--muted))]" /></div></div>;
}
  ...
  return (
    <div className="min-h-[100dvh] bg-[hsl(var(--background))]">
      ...
      <main className="mx-auto max-w-[840px] px-5 pb-32 pt-12 sm:px-12 sm:pt-16">
        <article className="ajaia-rise rounded-[22px] border border-[hsl(var(--border)/.72)] bg-[hsl(var(--card))] px-6 py-9 shadow-[0_18px_60px_hsl(var(--foreground)/.035)] sm:px-16 sm:py-14">
