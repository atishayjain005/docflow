...
function SkeletonRow() {
  return <div className="flex items-center gap-4 border-b border-[hsl(var(--border)/.7)] px-5 py-4"><div className="ajaia-skeleton h-10 w-10 rounded-xl bg-[hsl(var(--muted))]" /><div className="flex-1 space-y-2"><div className="ajaia-skeleton h-3 w-1/3 rounded bg-[hsl(var(--muted))]" /><div className="ajaia-skeleton h-2.5 w-2/3 rounded bg-[hsl(var(--muted))]" /></div><div className="ajaia-skeleton hidden h-3 w-16 rounded bg-[hsl(var(--muted))] sm:block" /></div>;
}
...
export default function Home() {
  ...
  return (
    <div className="mx-auto max-w-[1440px] px-5 pb-12 pt-6 sm:px-8 md:px-10 md:pt-10 lg:px-14">
      ...
      <section className="ajaia-rise ajaia-delay-4">
