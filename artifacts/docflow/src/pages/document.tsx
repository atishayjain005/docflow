    ...
    <div className="min-h-[100dvh] bg-[hsl(var(--background))]">
      <header className="sticky top-0 z-20 border-b border-[hsl(var(--border)/.8)] bg-[hsl(var(--background)/.9)] backdrop-blur-md">
        ...
        <div className="flex items-center gap-1 overflow-x-auto px-4 pb-2 sm:px-7">
          ...
          <button type="button" data-testid="button-format-heading" onClick={() => command('formatBlock', 'h2')} className="flex h-8 items-center gap-1 rounded-md px-2 text-xs font-bold text-[hsl(var(--muted-foreground))] transition hover:bg-[hsl(var(--muted))] hover:text-[hsl(var(--foreground))] active:scale-95">Heading <ChevronDown className="h-3 w-3" /></button>
